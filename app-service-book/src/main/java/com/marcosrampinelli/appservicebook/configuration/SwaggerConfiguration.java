package com.marcosrampinelli.appservicebook.configuration;
...
public class SwaggerConfiguration {
    ...
    public Docket api() { 
        return new Docket(DocumentationType.SWAGGER_2)
        		.select()
        		.apis(RequestHandlerSelectors.basePackage("com.marcosrampinelli.appservicebook"))
	...
	private ApiInfo apiInfo() {
		...
		return new ApiInfoBuilder()
				.title("AppServiceBook - API Documentation")
